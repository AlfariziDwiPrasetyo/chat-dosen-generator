...
function Memberitahu() {
  ...
  const chat = `Assalamu'alaikum wr. wb. Selamat ${waktu}, ${gender}. Mohon maaf mengganggu waktunya, saya ${nama} dari kelas ${kelas}, izin memberitahu bahwa ${keperluan}. Terima kasih banyak atas waktunya ${gender}. Wassalamu'alaikum wr. wb.`;
        ...
        <div className="poppins md:col-span-2 md:pl-40 pl-5 px-5">
          ...
          <label className="form-control w-full">
            ...
            <textarea
              ...
              placeholder="Contoh : Ada Perkuliahan hari ini jam sekian"
              value={keperluan}
